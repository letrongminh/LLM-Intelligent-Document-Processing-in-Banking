...
class DocumentLoader():
    ...
    """
    def __init__(self, reader: Any, parser: Any, source_url: Optional[str] = None) -> None:
        self._reader = reader
        self._parser = parser
        self._source_url = source_url
        
    def to_doc_objects(self, url: str) -> List[Document]:
        if hasattr(self._reader, 'class_name') and self._reader.class_name() == 'WikipediaReader':
